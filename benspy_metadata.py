...
if __name__=="__main__":
    ...
    pathrawxml = os.path.join(root_dl, 'SC3ML', f'v{version}')
    os.makedirs(pathrawxml, exist_ok=True)
    outxml = os.path.join(pathrawxml, f'{xmlfile}.scml')
    ...
    eida_dict = {'BQ.BA01': '2019-07-21T14:00:00',
                 ...
                 'BQ.BA14': '2023-03-30T00:00:00',
                 'BQ.BA16': '2019-10-28T13:00:00',
                 'BQ.BA17': '2023-02-15T00:00:00',
                 'BQ.BA18': '2019-11-01T00:00:00',
                 'BQ.BA19': '2023-03-30T00:00:00', 
                 'BQ.BA20': '2023-03-30T00:00:00',
                 'BQ.BA21': '2023-04-14T00:00:00',
                 'BQ.BA22': '2023-04-14T00:00:00',
                 'BQ.BA23': '2023-04-14T00:00:00',
